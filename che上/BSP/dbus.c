...
void rc_callback_handler(rc_info_t *rc, uint8_t *buff)
{
    ...
    rc->ch1 = (int16_t)((buff[0] | buff[1] << 8) & 0x07FF)-1024;
//    rc->ch1 -= 1024;
    rc->ch2 = (int16_t)((buff[1] >> 3 | buff[2] << 5) & 0x07FF)-1024;
//    rc->ch2 -= 1024;
    rc->ch3 = (int16_t)((buff[2] >> 6 | buff[3] << 2 | buff[4] << 10) & 0x07FF)-1024;
//    rc->ch3 -= 1024;
    rc->ch4 = (int16_t)((buff[4] >> 1 | buff[5] << 7) & 0x07FF)-1024;
//    rc->ch4 -= 1024;
